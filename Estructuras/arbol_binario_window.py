...
class BinaryTreeWindow(QWidget):
    ...
    def __init__(self):
        ...
        # Botón insertar izquierda
        insert_izquierda_button = QPushButton("Insertar (Izquierda)")
        insert_izquierda_button.setStyleSheet(button_style)
        insert_izquierda_button.setFont(QFont("Arial", 11))
        buttons_layout.addWidget(insert_izquierda_button)

        # Botón insertar derecha
        insert_derecha_button = QPushButton("Insertar (Derecha)")
        insert_derecha_button.setStyleSheet(button_style)
        insert_derecha_button.setFont(QFont("Arial", 11))
        buttons_layout.addWidget(insert_derecha_button)
