...
from edit_pila_data import InsertWindow, FindWindow, data
    ...
    def save_stack(self):
        ...
        if file_path:
            try:
                ...
                print("Error al guardar la pila:", str(e))
            ...
            try:
                with open(file_path, 'r') as file:
                    for line in file:
                        ...
                        data.prepend(dato)  # Agrega los datos a la pila
