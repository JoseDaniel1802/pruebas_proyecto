...
import sys
import math
from edit_lista_circular_doble_data import InsertFinalSinglyWindow, InsertInicioSinglyWindow, SearchSinglyWindow, data


class DoublyCircularListWindow(QWidget):
    window_closed = pyqtSignal()

    def __init__(self):
        super().__init__()
        self.setWindowTitle("Lista Circular Doble")
    ...
    def button_main(self, layout: QVBoxLayout):
        ...
        insert_pos_button = QPushButton("Insertar (Posición)")
        insert_pos_button.setStyleSheet(button_style)
        insert_pos_button.setFont(QFont("Arial", 11))
        insert_pos_button.clicked.connect(self.show_insert_pos_dialog)
        insert_layout.addWidget(insert_pos_button)
        ...
        eliminar_pos_button = QPushButton("Eliminar (Posición)")
        eliminar_pos_button.setStyleSheet(button_style)
        eliminar_pos_button.setFont(QFont("Arial", 11))
        eliminar_pos_button.clicked.connect(self.show_delete_pos_dialog)
        delete_layout.addWidget(eliminar_pos_button)
    ...
    def show_insert_pos_dialog(self):
        # Muestra una ventana de diálogo para insertar en una posición específica
        pass  # Aquí deberías mostrar la ventana de diálogo y manejar la inserción en la posición especificada
    ...
    def show_delete_pos_dialog(self):
        # Muestra una ventana de diálogo para eliminar en una posición específica
        pass  # Aquí deberías mostrar la ventana de diálogo y manejar la eliminación en la posición especificada
...
if __name__ == "__main__":
    ...
    window = DoublyCircularListWindow()
    window.show()
    sys.exit(app.exec())
